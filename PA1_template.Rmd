...
## substitute the NA values by 0 - if the number of steps is not reported the most logical assumption would be that no steps were taken
## create new dataset
dataSummarised3 <- data
dataSummarised3[is.na(dataSummarised3)] <- 0 #mean(data$steps[complete.cases(data$steps)])
